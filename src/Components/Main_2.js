...
// link type /upload/logo_link/w_800,h_500/name_link/text1_link/text2_link
    ...
    const[presentimg,setpresentimg]=useState(templateImg);
        ...
        const nameOnSubmit=(e)=>{
            ...
            let final_text=presentimg.slice(0,s)+"y_-30,l_text:Wellfleet_40_bold:"+fname+presentimg.slice(r);
            setpresentimg(final_text);
        }
        ...
        const text1OnSubmit=(e)=>{
            ...
            let final_text=presentimg.slice(0,ss+1)+"y_-90,l_text:Wellfleet_20:"+fname+presentimg.slice(r);
            setpresentimg(final_text);
        }
        const text2OnSubmit=()=>{
            ...
            let final_text=presentimg.slice(0,ss+1)+"y_50,l_text:Wellfleet_20:"+fname+presentimg.slice(r);
            setpresentimg(final_text);
